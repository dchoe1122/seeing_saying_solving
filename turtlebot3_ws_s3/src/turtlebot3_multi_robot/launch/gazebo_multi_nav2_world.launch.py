...
def generate_launch_description():
    ...
    keepout_map_server=Node(package='nav2_map_server',
        executable='map_server',
        name='map_server',
        output='screen',
        # This is the map server node that will load the map - change the map.yaml file to use your own map
        parameters=[{'yaml_filename': os.path.join(get_package_share_directory('turtlebot3_navigation2'), 'map', 'keepout_mask.yaml'),
                     },],
        remappings=remappings)

    keepout_map_server_lifecyle=Node(package='nav2_lifecycle_manager',
            executable='lifecycle_manager',
            name='lifecycle_manager_map_server',
            output='screen',
            parameters=[{'use_sim_time': use_sim_time},
    ...
    ld.add_action(keepout_map_server_lifecyle)
    ######################
